...
class UseOfHoyerLiftTrainingCompetency extends Component
{
    ...
    public array $hoyerLiftCompetencyItems = [];
    ...
    public function mount(
        ...
        $this->hoyerLiftCompetencyItems = $this->buildCompetencyItems();
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('hlt-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Use of Hoyer Lift Training assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->hoyerLiftCompetencyItems)
    ...
    protected function calculateScores(): array
    {
        ...
        foreach ($this->hoyerLiftCompetencyItems as $item) {
    ...
    {
        return collect($this->hoyerLiftCompetencyItems)
            ->filter(fn (array $item) => ! ($item['isParent'] ?? false))
            ->pluck('id')
            ->all();
    }
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.use-of-hoyer-lift-training-competency');
    }
}
