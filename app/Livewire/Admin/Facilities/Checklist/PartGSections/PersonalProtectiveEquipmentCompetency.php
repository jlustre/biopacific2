...
class PersonalProtectiveEquipmentCompetency extends Component
{
    ...
    public array $ppeCompetencyItems = [];
    ...
    public const SECTION = 'PERSONAL PROTECTIVE EQUIPMENT (PPE)';
    ...
    public function mount(
        ...
        $this->ppeCompetencyItems = $this->buildCompetencyItems();
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('ppe-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Personal Protective Equipment (PPE) assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->ppeCompetencyItems)
    ...
    protected function calculateScores(): array
    {
        ...
        foreach ($this->ppeCompetencyItems as $item) {
    ...
    {
        return collect($this->ppeCompetencyItems)
            ->filter(fn (array $item) => ! ($item['isParent'] ?? false))
            ->pluck('id')
            ->all();
    }
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.personal-protective-equipment-competency');
    }
}
