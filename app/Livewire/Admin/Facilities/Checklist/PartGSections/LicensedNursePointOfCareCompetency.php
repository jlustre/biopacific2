...
class LicensedNursePointOfCareCompetency extends Component
{
    ...
    public array $pocCompetencyItems = [];
    ...
    public const SECTION = 'LICENSED NURSE POINT OF CARE COMPETENCY';
    ...
    {
        return collect($this->pocCompetencyItems)
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.licensed-nurse-point-of-care-competency');
    }
}
