...
class BloodGlucoseSystemSkillsCompetency extends Component
{
    ...
    public array $glucoseCompetencyItems = [];
    ...
    public function mount(
        ...
        $this->glucoseCompetencyItems = $this->buildCompetencyItems();
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('bgs-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Blood Glucose System Skills Competency assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->glucoseCompetencyItems)
    ...
    protected function calculateScores(): array
    {
        ...
        foreach ($this->glucoseCompetencyItems as $item) {
    ...
    {
        return collect($this->glucoseCompetencyItems)
            ->filter(fn (array $item) => ! ($item['isParent'] ?? false))
            ->pluck('id')
            ->all();
    }
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.blood-glucose-system-skills-competency');
    }
}
