...
class CnaSkillsChecklistCompetency extends Component
{
    ...
    public array $cnaSkillsChecklistItems = [];
    ...
    public function mount(
        ...
        $this->cnaSkillsChecklistItems = $this->buildCompetencyItems();
    ...
    {
        return $this->calculateScoresFromSectionItems($this->cnaSkillsChecklistItems);
    }
    ...
    {
        return collect($this->cnaSkillsChecklistItems)
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.cna-skills-checklist-competency');
    }
}
