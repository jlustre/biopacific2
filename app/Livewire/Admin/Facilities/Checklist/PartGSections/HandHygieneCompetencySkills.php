...
class HandHygieneCompetencySkills extends Component
{
    ...
    public array $hygieneCompetencyItems = [];
    ...
    public function mount(
        ...
        $this->hygieneCompetencyItems = $this->buildCompetencyItems();
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('hhc-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Hand Hygiene Competency Skills assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->hygieneCompetencyItems)
    ...
    protected function calculateScores(): array
    {
        ...
        foreach ($this->hygieneCompetencyItems as $item) {
    ...
    {
        return collect($this->hygieneCompetencyItems)
            ->filter(fn (array $item) => ! ($item['isParent'] ?? false))
            ->pluck('id')
            ->all();
    }
    ...
    {
        return view('livewire.admin.facilities.checklist.part-g-sections.hand-hygiene-competency-skills');
    }
}
