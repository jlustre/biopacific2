...
class PerinealCareCompetency extends Component
{
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('pcc-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Perineal Care assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->perinealCareCompetencyItems)
    ...
    protected function calculateScores(): array
    {
        ...
        foreach ($this->perinealCareCompetencyItems as $item) {
