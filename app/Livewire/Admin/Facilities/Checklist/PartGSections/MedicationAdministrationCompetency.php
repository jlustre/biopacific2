...
class MedicationAdministrationCompetency extends Component
{
    ...
    public function setResponse(int $itemId, string $rating): void
    {
        ...
        $this->dispatch('mac-responses-updated', responses: $this->responses);
    }
    ...
    public function submitAssessment(): void
    {
        ...
        session()->flash('success', 'Medication Administration Competency assessment saved.');
    }
    ...
    protected function loadDraftResponses(): void
    {
        ...
        $sectionItemIds = collect($this->medicationAdministrationCompetencyItems)
