...
class EmployeesController extends Controller
{
    ...
    public function edit($employee_num)
    {
        ...
        // ...existing code that builds $competencyAssessmentHistory ...

        // Extract LICENSED NURSE COMPETENCY SKILLS summary for current period (must be after $competencyAssessmentHistory is built and $selectedAssessmentPeriodId is set)
        $lnSummary = null;
