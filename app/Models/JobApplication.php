...
class JobApplication extends Model
{
    ...
    protected $fillable = [
        'user_id', 'job_opening_id', 'first_name', 'last_name', 'email', 'phone', 'cover_letter', 'resume_path', 'consent', 'status', 'applicant_code', 'access_token', 'expires_at', 'audit_log', 'viewed_at'
    ];
