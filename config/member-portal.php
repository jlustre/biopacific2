...
return [
    ...
    */
    ...
    'nav_purpose_groups' => [
        ...
        [
            ...
            'items' => [
                ...
                ['id' => 'settings-competency-mgmt', 'route' => 'admin.competencies.index', 'route_is' => ['admin.competencies.*'], 'icon' => '✅', 'label' => 'Competencies Management', 'gate' => 'documents_mgmt'],
                ['id' => 'settings-performance-mgmt', 'route' => 'admin.performances.index', 'route_is' => ['admin.performances.*'], 'icon' => '📋', 'label' => 'Performance Management', 'gate' => 'documents_mgmt'],
    ...
    'admin_titles' => [
        ...
        'admin.competencies.*' => 'Competencies Management',
    ...
    'admin_active_map' => [
        ...
        'admin.competencies.*' => 'settings-competency-mgmt',
        'admin.performances.*' => 'settings-performance-mgmt',
