...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pre_employment_applications', function (Blueprint $table) {
            ...
            $table->string('employment_type')->nullable(); // full_time, part_time, temporary, other
            ...
            $table->boolean('applied_here_before')->nullable();
            $table->text('applied_here_when_where')->nullable();
            ...
            $table->date('drivers_license_expiration')->nullable();
            // How Heard About Us
