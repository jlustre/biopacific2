...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('employee_competency_assessments', function (Blueprint $table) {
            if (! Schema::hasColumn('employee_competency_assessments', 'employee_signature_path')) {
                $table->string('employee_signature_path')->nullable()->after('employee_signed_at');
            }

            if (! Schema::hasColumn('employee_competency_assessments', 'employee_confirmation_snapshot')) {
