        ...
        <div class="container-fluid mt-12">
            ...
            <div class="container-fluid">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div
                        class="bg-white p-4 rounded-2xl shadow-lg border-t-4 border-accent hover:shadow-xl transition-shadow">
                    ...
                    <div
                        class="bg-white p-6 rounded-2xl shadow-lg border-t-4 border-yellow-400 hover:shadow-xl transition-shadow">
                        <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div
                        class="bg-white p-6 rounded-2xl shadow-lg border-t-4 border-blue-400 hover:shadow-xl transition-shadow">
                        <div class="flex items-center space-x-3 mb-3">
                    ...
                    <div
                        class="bg-white p-6 rounded-2xl shadow-lg border-t-4 border-purple-400 hover:shadow-xl transition-shadow">
                        <div class="flex items-center space-x-3 mb-3">
