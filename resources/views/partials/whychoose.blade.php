...
<div class="bg-gradient-to-r from-white to-slate-50 rounded-3xl shadow-xl p-4 border border-slate-100">
    ...
    <div class="text-center mb-16">
        <h2 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
            Why Choose <span style="color: {{ $primary }};">{!! $facility['name'] !!}</span>?
        </h2>
        <p class="text-2xl lg:text-3xl text-slate-600 max-w-4xl mx-auto">
            Experience the difference that genuine care, modern amenities, and a warm community
            atmosphere can make.
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="text-center group">
            ...
            <p class="text-slate-600 leading-relaxed">Fully licensed and regulated facility meeting the highest
                standards
        ...
        <div class="text-center group">
            ...
            <p class="text-slate-600 leading-relaxed">Engaging social activities, wellness programs, and community
                events
