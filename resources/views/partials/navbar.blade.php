...
">
  ...
  <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
    <button class="flex items-center gap-1 transition-colors duration-200 hover:text-primary dark:hover:text-blue-400"
    ...
    <div x-show="open"
      ...
      <a href="#about" @click="activeSection = 'about'"
         class="block px-4 py-2 transition-colors duration-200 hover:bg-blue-50 dark:hover:bg-blue-900/20 hover:text-primary dark:hover:text-blue-400"
  ...
  <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
    <button class="flex items-center gap-1 transition-colors duration-200 hover:text-primary dark:hover:text-blue-400"
            :class="{'text-primary dark:text-blue-200 font-semibold': activeSection === 'rooms' || activeSection === 'gallery'}">
      Facilities
      <svg class="w-4 h-4 transition-transform duration-200" :class="{'rotate-180': open}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
      </svg>
