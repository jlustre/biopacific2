...
<section id="careers" x-data="{ 
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mb-12">
      <h3 class="text-2xl font-bold text-center mb-8 text-secondary">Job Applications</h3>
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-slate-200">
          <thead class="bg-slate-50">
            <tr>
              <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-slate-500 uppercase tracking-wider">
                Position
              </th>
              <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-slate-500 uppercase tracking-wider">
                Name
              ...
              <th scope="col" class="px-6 py-3 text-right text-sm font-medium text-slate-500 uppercase tracking-wider">
                Actions
              </th>
            </tr>
          </thead>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-right">
                <a href="{{ route('applications.show', $application->id) }}"
                  ...
                  <svg class="w-5 h-5 inline-block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M15 12H9m6 4H9m6-8H9m6 4a6 6 0 11-12 0 6 6 0 0112 0z" />
                  </svg>
                  View
                </a>
              </td>
