          ...
          <div class="lg:w-3/5 p-8 lg:p-12 flex flex-col justify-between">
            <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                <div class="flex items-center p-3 bg-slate-50 rounded-xl">
                  <div
                    class="w-10 h-10 bg-blue-500/10 rounded-full flex items-center justify-center mr-3 flex-shrink-0">
    ...
    <div class="bg-gradient-to-r from-white to-slate-50 rounded-3xl shadow-xl p-12 border border-slate-100">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="text-center group">
          <div
            class="w-20 h-20 bg-gradient-to-br from-primary to-secondary rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300 shadow-lg">
