<nav x-data="{ mobileOpen: false }" class="w-full shadow-md mb-2 mr-4 bg-amber-300">
    <div class="w-full px-2 sm:px-4 -ml-[16px] mr-[16px]">
        <div class="flex justify-between items-center h-16 w-full min-w-0">
            ...
            <!-- Desktop Navigation -->
            <div
                class="hidden md:flex gap-2 items-center pl-4 py-2 ml-auto mr-0 lg:mr-0 xl:mr-0 flex-1 min-w-0 justify-end">
                <!-- About Dropdown -->
                @php
