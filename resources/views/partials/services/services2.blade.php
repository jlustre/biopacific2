...
<section id="services" class="relative overflow-hidden py-16 sm:py-24 bg-gradient-to-br from-slate-50 to-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        'section_sub_header' => 'Comprehensive care and enriching services designed to enhance quality of life for
        every resident.'
        ])
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li class="flex items-start gap-2">
                                <span
                                    class="mt-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-slate-100">
