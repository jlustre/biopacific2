...
<section id="services" class="py-16 bg-gradient-to-br from-teal-800 via-teal-400 to-teal-600">
    ...
    <div id="modal-{{ $service->id }}"
        ...
        <div class="relative max-w-2xl w-full bg-white rounded-3xl shadow-2xl ring-1 ring-blue-900/10 p-10 mx-auto flex flex-col"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                ...
                <div>
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="#contact"
                            class="cursor-pointer text-center flex-inline flex-col items-end justify-center px-3 py-2 bg-gradient-to-r from-teal-700 to-teal-500 text-white font-semibold rounded-full shadow hover:from-teal-800 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
                            onclick="closeServiceModal4('modal-{{ $service->id }}')">
                            <span class="font-bold text-sm">Contact Us About This Service</span>
                        </a>
                    </div>
                </div>
            </div>
            <div class="mt-6 text-left text-lg w-full">{!! $service->detailed_description !!}</div>
