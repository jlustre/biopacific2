...
<section id="services" class="py-16 bg-gradient-to-br from-slate-900 via-blue-900 to-blue-700">
        ...
        <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div
                ...
                <div class="relative h-44 overflow-hidden">
                    ...
                    <span
                        class="absolute bottom-3 left-3 bg-blue-700 text-white text-lg font-bold px-4 py-1 rounded-full shadow-lg uppercase tracking-wide">{{
                        $service->name }}</span>
                </div>
                <div class="flex-1 flex flex-col p-6">
                    ...
                    <div class="mt-auto pt-4">
                        <button onclick="openServiceModal4('modal-{{ $service->id }}')"
                            class="w-full inline-flex items-center justify-center px-6 py-2.5 bg-gradient-to-r from-blue-700 to-blue-500 text-white font-semibold rounded-full shadow hover:from-blue-800 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 transition cursor-pointer">Details</button>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div id="modal-{{ $service->id }}"
        ...
        <div class="relative max-w-2xl w-full bg-white rounded-3xl shadow-2xl ring-1 ring-blue-900/10 p-10 mx-auto flex flex-col items-center"
            ...
            <h3 id="modal-title-{{ $service->id }}" class="text-3xl font-bold text-blue-900 mb-2">{{ $service->name }}
            </h3>
            <div class="text-blue-800 mb-6 text-left text-lg w-full">{!! $service->detailed_description !!}</div>
            ...
            <a href="#contact"
                class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-700 to-blue-500 text-white font-semibold rounded-full shadow hover:from-blue-800 hover:to-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 transition mt-2"
