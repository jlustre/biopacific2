...
=======
      'section_header' => 'Our <span class="text-accent">Services & Amenities</span>',
      'section_sub_header' => 'Comprehensive care and enriching amenities designed to enhance quality of life for every resident.'
>>>>>>> 5a7e1f9599c22a67bfe93c9cd3f696bb1a5ec0be
    ])
...
<<<<<<< HEAD
      ...
      <div
        class="group relative overflow-hidden rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 cursor-pointer"
...
=======
          Our team is here to answer your questions and help you understand how our services can benefit you or your loved one.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="#contact" class="inline-flex items-center justify-center gap-2 bg-accent text-white px-8 py-3 rounded-full hover:bg-accent/90 transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
            </svg>
            <span>Contact Us</span>
          </a>
          <a href="#about" class="inline-flex items-center justify-center gap-2 bg-white text-accent border-2 border-accent px-8 py-3 rounded-full hover:bg-accent hover:text-white transition-colors">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<<<<<<< HEAD
  <div id="modal-{{ $index }}"
    ...
    <div
      class="bg-white rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl transform transition-all duration-300 scale-95 opacity-0"
...
=======
        ...
        <button onclick="closeModal('modal-{{ $index }}')" class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors">
>>>>>>> 5a7e1f9599c22a67bfe93c9cd3f696bb1a5ec0be
...
<<<<<<< HEAD
                <div
                  ...
                  <svg class="w-3 h-3 text-{{ $service['color'] }}-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
=======
                <div class="w-5 h-5 rounded-full bg-{{ $service['color'] }}-100 flex items-center justify-center mt-0.5 flex-shrink-0">
                  <svg class="w-3 h-3 text-{{ $service['color'] }}-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
>>>>>>> 5a7e1f9599c22a67bfe93c9cd3f696bb1a5ec0be
...
=======
          <button onclick="closeModalAndNavigate('modal-{{ $index }}', '#contact')" class="flex-1 bg-accent text-white px-6 py-3 rounded-full text-center hover:bg-accent/90 transition-colors">
            Contact Us About This Service
          </button>
          <button onclick="closeModal('modal-{{ $index }}')" class="flex-1 bg-gray-100 text-gray-700 px-6 py-3 rounded-full hover:bg-gray-200 transition-colors">
>>>>>>> 5a7e1f9599c22a67bfe93c9cd3f696bb1a5ec0be
            Close
          </button>
        </div>
