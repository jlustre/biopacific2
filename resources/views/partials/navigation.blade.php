...
<img src="{{ $facility['logo_url'] }}" alt="{{ $facility['name'] ?? 'Facility' }} Logo" class="h-8 w-auto">
@else
@php
...
@endphp
<div class="h-8 w-8 rounded-lg flex items-center justify-center" style="background-color: {{ $primary }};">
...
<nav class="bg-white shadow-lg fixed top-0 w-full z-50">
    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex-shrink-0 flex items-center">
        <a href="{{ url('/') }}" class="flex items-center">
          ...
          <img src="{{ $facility['logo_url'] }}" alt="{{ $facility['name'] }} Logo" class="h-8 w-auto">
          @else
      ...
      <div class="hidden md:block">
        <div class="ml-10 flex items-baseline space-x-8">
          <a href="#hero" class="text-gray-700 hover:text-primary px-3 py-2 text-sm font-medium transition-colors"
            style="hover:color: {{ $primary }};">
            Home
          </a>
          <a href="#about" class="text-gray-700 hover:text-primary px-3 py-2 text-sm font-medium transition-colors"
            style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
            About Us
          </a>
          <a href="#services" class="text-gray-700 hover:text-primary px-3 py-2 text-sm font-medium transition-colors"
            style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
            Services
          </a>
      ...
      <div class="md:hidden">
        <button type="button"
          ...
          style="focus:ring-color: {{ $facility['primary_color'] ?? '#047857' }};" onclick="toggleMobileMenu()">
  ...
  <div class="md:hidden hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gray-50 border-t">
      <a href="#hero" class="text-gray-700 hover:text-primary block px-3 py-2 text-base font-medium"
        style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
        Home
      </a>
      <a href="#about" class="text-gray-700 hover:text-primary block px-3 py-2 text-base font-medium"
        style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
        About Us
      </a>
      <a href="#services" class="text-gray-700 hover:text-primary block px-3 py-2 text-base font-medium"
        style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
        Services
      </a>
      <a href="#contact" class="text-gray-700 hover:text-primary block px-3 py-2 text-base font-medium"
        style="hover:color: {{ $facility['primary_color'] ?? '#047857' }};">
        Contact
      </a>
