          ...
          @if(isset($facility['address']) && $facility['address'])
            <div class="flex items-start">
              <div class="w-6 h-6 mt-1 mr-4 flex-shrink-0">
                <svg fill="currentColor" style="color: {{ $facility['primary_color'] ?? '#047857' }};" viewBox="0 0 20 20">
      ...
      @if($config['show_form'] ?? true)
        <div>
          ...
          <form class="space-y-6">
            ...
            <button type="submit"
                    class="w-full px-6 py-3 font-semibold rounded-lg text-white transition-colors"
