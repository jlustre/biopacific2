    ...
    <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 -mt-12 pb-12">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 flex flex-col gap-8">
                <div class="rounded-3xl bg-white/80 shadow-xl border border-slate-100 p-6 sm:p-10 backdrop-blur">
                    <form class="space-y-6">
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                <label for="contact_name" class="block text-sm font-medium text-slate-700 mb-1">Full
                                    Name *</label>
                            ...
                            <div>
                                <label for="contact_email" class="block text-sm font-medium text-slate-700 mb-1">Email
                                    Address *</label>
                            ...
                            <div class="md:col-span-2">
                                <label for="contact_message"
                                    class="block text-sm font-medium text-slate-700 mb-1">Message *</label>
                        ...
                        <div class="flex flex-col gap-2 mt-2">
                            <div class="flex items-center">
                                ...
                                <label for="no-phi" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">I
                                    confirm that I will not include any Protected Health Information (PHI) in this
                                    form.</label>
                            </div>
