      ...
      <div class="flex justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 max-w-6xl">
          ...
          <div class="lg:col-span-1 space-y-6">
            ...
            <p class="text-slate-300 leading-relaxed">{{ $facility['tagline'] ?? 'Quality care for your loved ones' }}
            </p>
            ...
            <div class="space-y-4">
              ...
              <div class="flex items-center gap-3">
                ...
                <a href="tel:{{ $facility['phone'] ?? '' }}"
                  class="text-slate-300 hover:text-primary transition-colors">{{ $facility['phone'] ?? 'Contact us'
                  }}</a>
              </div>
              <div class="flex items-center gap-3">
                <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
