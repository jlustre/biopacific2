  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-16">
      <h2 class="text-4xl md:text-5xl font-bold text-secondary mb-4">
        Our <span class="text-accent">Services & Amenities</span>
      </h2>
      <p class="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
        Comprehensive care and enriching amenities designed to enhance quality of life for every resident.
      </p>
      <a href="#contact" class="inline-flex items-center gap-2 bg-accent text-white px-6 py-3 rounded-full hover:bg-accent/90 transition-colors">
