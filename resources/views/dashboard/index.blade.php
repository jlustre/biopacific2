...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <div class="bg-gradient-to-br from-primary to-green-600 p-3 rounded-xl shadow-lg">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                        </svg>
                    </div>
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Bio-Pacific Healthcare</h1>
                        <p class="text-gray-600">Network Site Directory</p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <!-- Search and Filter -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8" x-data="{ search: '', selectedState: '' }">
            <div class="flex flex-col sm:flex-row gap-4">
                ...
                <div class="sm:w-48">
                    ...
                    <select x-model="selectedState" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" x-data="{ search: '', selectedState: '' }">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200 overflow-hidden"
                 x-show="(search === '' ||
                        ...
                        (selectedState === '' || selectedState === '{{ $facility->state }}')"
                 x-transition>
        ...
        <!-- Empty State -->
        <div x-show="document.querySelectorAll('[x-show]:not([style*=\"display: none\"])').length === 0"
             x-transition
