...
<head>
    ...
    <title>Bio-Pacific Healthcare Network</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8">
                <div class="bg-gradient-to-br from-primary to-green-600 p-4 rounded-2xl shadow-lg inline-block mb-4">
                ...
                <a href="/dashboard"
                   class="block bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200 p-6 group">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 group-hover:text-primary transition-colors">Site Directory</h3>
                ...
                <a href="/admin/facility/1/preview"
                   class="block bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-200 p-6 group">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-semibold text-gray-900 group-hover:text-accent transition-colors">Preview Sample Site</h3>
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-xl p-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-amber-700">You're in local development. The system will automatically handle tenant resolution for testing.</p>
                        </div>
                    </div>
                </div>
            </div>
