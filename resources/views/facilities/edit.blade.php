...
<div class="bg-white min-h-screen py-12">
    <div class="max-w-4xl mx-auto px-4">
        ...
        <form action="{{ route('facilities.update', $facility) }}" method="POST" enctype="multipart/form-data" class="bg-white shadow-md rounded-lg p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="ranking_position" name="ranking_position" value="{{ old('ranking_position', $facility->ranking_position) }}"
                ...
                <div>
                    ...
                    <input type="number" id="ranking_total" name="ranking_total" value="{{ old('ranking_total', $facility->ranking_total) }}"
                ...
                @if($facility->hero_image_url)
                    <div class="md:col-span-2">
                        ...
                        <div class="mb-4">
                            <img src="{{ $facility->hero_image_url }}" alt="Current hero image" class="h-32 w-auto rounded-lg border">
                        </div>
                    </div>
                @endif
