  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
      @foreach($facilities as $index => $facility)
        @php
          ...
          $placeholderImages = [
            'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Modern hospital exterior
            'https://images.unsplash.com/photo-1587351021759-3e566b6af7cc?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Hospital corridor
            'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Medical facility interior
            'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Modern hospital room
            'https://images.unsplash.com/photo-1666214280557-f1b5022eb634?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Hospital building
            'https://images.unsplash.com/photo-1564015709027-d5c8f6bd7cb5?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Medical equipment room
            'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Hospital entrance
            'https://images.unsplash.com/photo-1586773860418-d37222d8eeb4?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Medical center lobby
            'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=800&h=600&fit=crop&crop=faces&auto=format&q=80', // Healthcare facility
            'https://images.unsplash.com/photo-1576091160399-112ba8d25d1f?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Emergency department
            'https://images.unsplash.com/photo-1582750433449-648ed127bb54?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // Operating room
            'https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?w=800&h=600&fit=crop&crop=center&auto=format&q=80', // ICU room
          ];
        ...
        <div class="group bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100">
          ...
          <!-- Content -->
          <div class="p-6">
            <a href="{{ route('facility.show', $facility->slug) }}" class="block group-hover:text-opacity-80 transition-colors">
          ...
          <!-- Admin Actions -->
          @can('edit facilities')
            <div style="background-color: var(--primary-color, #3B82F6);" class="bg-opacity-5 border-t border-gray-100 px-6 py-3">
    ...
    @if($facilities->isEmpty())
      <div class="text-center py-16">
        ...
        @can('create facilities')
          <a href="{{ route('facilities.create') }}"
             style="background-color: var(--primary-color, #3B82F6);"
