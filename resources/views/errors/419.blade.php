...
<head>
    ...
    <title>419 Page Expired - Bio-Pacific Healthcare</title>
...
<body>
    <div class="min-h-screen flex items-center justify-center px-4">
        <div
            ...
            <img src="{{ asset('images/419.png') }}" alt="419 Page Expired"
                class="mb-6 w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 object-contain drop-shadow-lg">
            <p class="text-base md:text-lg text-gray-700 mb-6">Your session has expired due to inactivity or a security
                timeout.<br class="hidden md:inline"> Please refresh the page or log in again.</p>
