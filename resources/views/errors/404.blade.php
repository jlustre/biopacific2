...
<head>
    ...
    <title>404 Not Found - Bio-Pacific Healthcare</title>
    ...
    <div class="min-h-screen flex items-center justify-center px-4">
        <div
            ...
            <img src="{{ asset('images/404.png') }}" alt="404 Not Found"
                class="mb-6 w-32 h-32w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 md object-contain drop-shadow-lg">

            <p class="text-base md:text-lg text-gray-700 mb-6">Sorry, the page you are looking for does not exist.<br
                    class="hidden md:inline"> You can return to your dashboard or use the navigation menu.</p>
