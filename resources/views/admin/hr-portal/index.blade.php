...
<div class="container py-4">
    ...
    <div class="bg-white p-6 rounded shadow">
        <p>Welcome to the HR Management. Select a facility to view its dashboard:</p>
        @if(isset($facilities) && $facilities instanceof \Illuminate\Support\Collection)
        @if($facilities->isEmpty())
        <div class="text-red-600 mt-4">You do not have access to any facility HR Management.</div>
        @else
