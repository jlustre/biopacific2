            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.facilities.index') }}" class="text-gray-500 hover:text-gray-700">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 2<script>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name', $facility->name) }}"
                                        class="w-full rounded border border-gray-400 bg-yellow-50 px-2 shadow-sm focus:border-primary focus:ring-primary"
                                        required>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="about_text" name="about_text" rows="4"
                                        class="w-full rounded border border-gray-400 bg-yellow-50 px-2 shadow-sm focus:border-primary focus:ring-primary">{{ old('about_text', $facility->about_text) }}</textarea>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <input type="text"
                                            value="{{ old('primary_color', $facility->primary_color ?? '#047857') }}"
                                            class="flex-1 rounded border border-gray-400 bg-yellow-50 px-2 shadow-sm focus:border-primary focus:ring-primary"
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <select name="variances[{{ $key }}]" id="variance_{{ $key }}"
                                            class="rounded border border-gray-400 bg-yellow-50 px-2 shadow-sm focus:border-primary focus:ring-primary"
                                            {{ $isActive ? '' : 'disabled' }}>
