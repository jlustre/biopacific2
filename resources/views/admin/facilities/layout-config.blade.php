...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <a href="{{ route('admin.facilities.edit', $facility->id) }}" class="text-gray-500 hover:text-gray-700">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600">{{ $facility->name }} - {{ ucfirst($facility->layout_template) }}</p>
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form action="{{ route('admin.facilities.update-layout-config', $facility->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="hero_config[text_alignment]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="left" {{ ($layoutConfig['hero_config']['text_alignment'] ?? 'left') === 'left' ? 'selected' : '' }}>Left</option>
                                        <option value="center" {{ ($layoutConfig['hero_config']['text_alignment'] ?? 'left') === 'center' ? 'selected' : '' }}>Center</option>
                                        <option value="right" {{ ($layoutConfig['hero_config']['text_alignment'] ?? 'left') === 'right' ? 'selected' : '' }}>Right</option>
                                    </select>
                                </div>

                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Overlay Opacity</label>
                                    <select name="hero_config[overlay_opacity]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="0.3" {{ ($layoutConfig['hero_config']['overlay_opacity'] ?? '0.3') === '0.3' ? 'selected' : '' }}>30%</option>
                                        <option value="0.5" {{ ($layoutConfig['hero_config']['overlay_opacity'] ?? '0.3') === '0.5' ? 'selected' : '' }}>50%</option>
                                        <option value="0.7" {{ ($layoutConfig['hero_config']['overlay_opacity'] ?? '0.3') === '0.7' ? 'selected' : '' }}>70%</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="about_config[layout]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="image-left" {{ ($layoutConfig['about_config']['layout'] ?? 'image-left') === 'image-left' ? 'selected' : '' }}>Image Left</option>
                                        <option value="image-right" {{ ($layoutConfig['about_config']['layout'] ?? 'image-left') === 'image-right' ? 'selected' : '' }}>Image Right</option>
                                    </select>
                                </div>

                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Show Stats</label>
                                    <select name="about_config[show_stats]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="true" {{ ($layoutConfig['about_config']['show_stats'] ?? 'true') === 'true' ? 'selected' : '' }}>Yes</option>
                                        <option value="false" {{ ($layoutConfig['about_config']['show_stats'] ?? 'true') === 'false' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="services_config[columns]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="2" {{ ($layoutConfig['services_config']['columns'] ?? '3') === '2' ? 'selected' : '' }}>2 Columns</option>
                                        <option value="3" {{ ($layoutConfig['services_config']['columns'] ?? '3') === '3' ? 'selected' : '' }}>3 Columns</option>
                                        <option value="4" {{ ($layoutConfig['services_config']['columns'] ?? '3') === '4' ? 'selected' : '' }}>4 Columns</option>
                                    </select>
                                </div>

                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Show Icons</label>
                                    <select name="services_config[show_icons]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="true" {{ ($layoutConfig['services_config']['show_icons'] ?? 'true') === 'true' ? 'selected' : '' }}>Yes</option>
                                        <option value="false" {{ ($layoutConfig['services_config']['show_icons'] ?? 'true') === 'false' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="contact_config[show_map]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="true" {{ ($layoutConfig['contact_config']['show_map'] ?? 'true') === 'true' ? 'selected' : '' }}>Yes</option>
                                        <option value="false" {{ ($layoutConfig['contact_config']['show_map'] ?? 'true') === 'false' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>

                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Show Contact Form</label>
                                    <select name="contact_config[show_form]" class="w-full rounded border-gray-300 text-sm">
                                        <option value="true" {{ ($layoutConfig['contact_config']['show_form'] ?? 'true') === 'true' ? 'selected' : '' }}>Yes</option>
                                        <option value="false" {{ ($layoutConfig['contact_config']['show_form'] ?? 'true') === 'false' ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
                        </div>
