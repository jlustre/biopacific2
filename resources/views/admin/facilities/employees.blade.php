...
<div class="container py-8">
    ...
    <div class="bg-white p-6 rounded shadow">
        ...
        <div id="partF" class="tab-content hidden">
            <h2 class="text-xl font-bold mb-4">PART F - EMPLOYEE PERFORMANCE APPRAISAL (Non-Management Position)</h2>
            <div class="mb-4">
                <div class="flex flex-col md:flex-row md:space-x-8 mb-2">
                    <div class="mb-2 md:mb-0">
                ...
                <table class="min-w-full border text-xs md:text-sm mb-4">
                    <tr><td class="border px-2 py-1 font-semibold">Name</td><td class="border px-2 py-1"></td><td class="border px-2 py-1 font-semibold">Review Date</td><td class="border px-2 py-1"></td></tr>
                    <tr><td class="border px-2 py-1 font-semibold">Position</td><td class="border px-2 py-1"></td><td class="border px-2 py-1 font-semibold">Date Employed</td><td class="border px-2 py-1"></td></tr>
                    <tr><td class="border px-2 py-1 font-semibold">Department</td><td class="border px-2 py-1"></td><td class="border px-2 py-1 font-semibold">Review</td><td class="border px-2 py-1"></td></tr>
                    <tr><td class="border px-2 py-1 font-semibold">Reviewers Name</td><td class="border px-2 py-1"></td><td class="border px-2 py-1 font-semibold">Type of Review</td><td class="border px-2 py-1"></td></tr>
                </table>
                <div class="italic text-xs text-gray-600 mb-2">
                    <strong>Instructions on Completing This Form:</strong> The performance appraisal form is designed to communicate behaviors that model Company's performance expectations. This appraisal should reflect overall performance of the employee considering such factors as knowledge, skills, and abilities, but primarily on whether the employee’s performance produced the desired results. An explanation will be required in the comments section where the rating either exceeds or is below the expectation level.
                </div>
                <div class="italic text-xs text-gray-600 mb-2">
                    <strong>When to Use This Form:</strong> The Employee Appraisal should be used for both exempt and non-exempt employees. This performance appraisal form is to be completed in conjunction with salary reviews, promotions, transfers, and may also be completed on terminations, or otherwise when considered desirable.
                </div>
                <div class="italic text-xs text-gray-600 mb-2">
                    <strong>How to Use This Form:</strong> The immediate supervisor will complete all sections and discuss with employee. Employees should be asked to sign the appraisal, acknowledging that he/she has participated in the review. Place one copy of the performance appraisal in the employee’s file. Provide a copy to the employee.
                </div>
            </div>
            <div class="mb-4">
                ...
                <table class="min-w-full border text-xs md:text-sm mb-4">
                    ...
                    <tbody>
                        <tr><td class="border px-2 py-1">The employee exceeds the majority of performance expectations.</td><td class="border px-2 py-1">E = Exceeds</td><td class="border px-2 py-1">3</td></tr>
                        <tr><td class="border px-2 py-1">The employee meets performance expectations with occasional deviations above and below expectations.</td><td class="border px-2 py-1">M = Meets</td><td class="border px-2 py-1">2</td></tr>
                        <tr><td class="border px-2 py-1">The employee has failed to meet one or more of the significant performance expectations.</td><td class="border px-2 py-1">B = Below</td><td class="border px-2 py-1">1</td></tr>
                    </tbody>
                </table>
            </div>
            <div class="mb-4">
                ...
                <div class="italic text-xs text-gray-600 mb-2">
                    Assess the employee’s knowledge, skills, and abilities, as outlined below. Place the appropriate number in the box that describes the employee’s performance for each description. The rating value column will auto fill, as will the section totals.
                </div>
                <!-- Section I -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Understands the job role and duties.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Initiates work projects without prompting, once briefed.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Demonstrates proficiency in all phases of the job.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Produces complete and accurate work.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section I Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section II -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    <thead>
                        <tr class="bg-gray-100">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Starts work promptly and can be depended upon to be available for work.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Remains at work area as required.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Maintains confidentiality.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Takes appropriate actions and follows instructions as directed.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section II Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section III -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Adapts to changing situations.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Willing to assist others in accomplishing additional work.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Considers viewpoints of others and accepts constructive feedback.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Cooperates with other employees in a positive, supportive, and courteous manner.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section III Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section IV -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Coordinates and maintains current work flow.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Recognizes priorities and meets deadlines.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Pays attention to detail.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Works well under pressure.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section IV Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section V -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Listens effectively and expresses understanding.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Consistently fosters respect in the workplace and demonstrates Company's Guiding Principles and Values.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Promotes understanding and acceptance of individual and cultural differences in the workplace.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Provides clear, concise, and accurate verbal and written information in an appropriate and timely manner.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section V Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section VI -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Identifies existing problems.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Anticipates and identifies potential problems.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Knows how and where to obtain necessary information.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Considers possible alternatives and makes thoughtful recommendations.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section VI Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Section VII -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    ...
                    <tbody>
                        <tr><td colspan="2" class="border px-2 py-1">Follows best practices for workstation ergonomics as guided by management</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Maintains good housekeeping in and around work area (clear aisles and cooridors, under desk clearance, etc.)</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Participates is safety and health initiatives as needed and/or requested</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Attends to created and observed spills and other slip hazards immediately upon discovery</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Wears slip resistant footwear</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Keeps electrical cords and similar hazards out of walking paths</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Removes or otherwise protects trip hazards</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Uses proper equipment such as stools or proper ladder for tasks involving reaching overhead</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Disposes of trash and waste, including biohazardous waste that requires special handling, in accordance with Company policies and procedures</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Reports unsafe conditions and practices as observed. Corrects on the spot if possible.</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Takes ownership of observed hazards (correct or protect and report). Contribute sustainable ideas to help build and maintain a safety culture</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Exhibits concern for the safety & health of residents and colleagues</td><td class="border px-2 py-1"></td></tr>
                        <tr><td colspan="2" class="border px-2 py-1">Considers possible alternatives and makes thoughtful recommendations to safety committee, actively participates in training, and promotes safety culture.</td><td class="border px-2 py-1"></td></tr>
                        <tr class="bg-yellow-100 font-bold"><td colspan="2" class="border px-2 py-1">Section VII Rating</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="mb-2"><label class="font-semibold">Comments:</label><textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea></div>
                <!-- Totals -->
                <table class="min-w-full border text-xs md:text-sm mb-2">
                    <tbody>
                        <tr class="bg-red-100 font-bold"><td class="border px-2 py-1">Total of All Sections</td><td class="border px-2 py-1">0.00</td></tr>
                        <tr class="bg-red-100 font-bold"><td class="border px-2 py-1">Overall Rating (divided by 7 for equal weighting)</td><td class="border px-2 py-1">0.00</td></tr>
                    </tbody>
                </table>
                <div class="italic text-xs text-gray-600 mb-2">
                    Use the number from the shaded box above to determine the overall performance rating according to the guidelines below. Write the appropriate E, M, or B in the shaded box below.
                </div>
                <table class="min-w-full border text-xs md:text-sm mb-4">
                    <thead>
                        <tr class="bg-gray-100">
                    ...
                    <tbody>
                        <tr><td class="border px-2 py-1">The employee exceeds the majority of performance expectations.</td><td class="border px-2 py-1">E = EXCEEDS EXPECTATIONS</td><td class="border px-2 py-1">2.51 – 3.00</td></tr>
                        <tr><td class="border px-2 py-1">The employee meets performance expectations with occasional deviations above and below expectations.</td><td class="border px-2 py-1">M = MEETS EXPECTATIONS</td><td class="border px-2 py-1">1.75 – 2.50</td></tr>
                        <tr><td class="border px-2 py-1">The employee has failed to meet one or more of the significant performance expectations.</td><td class="border px-2 py-1">B = BELOW EXPECTATIONS</td><td class="border px-2 py-1">1.00 – 1.74</td></tr>
                    </tbody>
                </table>
            ...
            <div class="mb-4">
                ...
                <div class="mb-2">
                    ...
                    <div class="italic text-xs text-gray-600 mb-1">Describe the areas in the employee’s performance that need to be further developed.</div>
                    <textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea>
                </div>
                <div class="mb-2">
                    <label class="font-semibold">Development Plans:</label>
                    <div class="italic text-xs text-gray-600 mb-1">Indicate plans to develop or improve the employee’s performance or potential.</div>
                    <textarea class="border rounded w-full min-h-[40px] mt-1" rows="2"></textarea>
                </div>
                <div class="mb-2">
            ...
            <div class="mb-4">
                ...
                <table class="min-w-full border text-xs md:text-sm mb-4">
                    ...
                    <tbody>
                        <tr><td class="border px-2 py-1">Supervisor:</td><td class="border px-2 py-1"></td></tr>
                        <tr><td class="border px-2 py-1">Employee:</td><td class="border px-2 py-1"></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
