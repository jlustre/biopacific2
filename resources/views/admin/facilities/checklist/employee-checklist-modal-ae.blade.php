<div id="verifyModal" class="fixed inset-0 bg-black bg-opacity-40 items-center justify-center z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
        ...
        <h3 class="text-lg font-bold mb-4">Document Type Item Confirmation</h3>
        <form id="verifyForm">
            <input type="hidden" name="employee_num" id="verifyEmpId">
            <input type="hidden" name="checklist_item_id" id="verifyChecklistItemId">
            ...
            <div id="subitemValidationMsg" class="mb-3 text-sm text-red-600 hidden"></div>
