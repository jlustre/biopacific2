        ...
        <table class="min-w-full border text-xs md:text-sm">
            ...
            <tbody>
                ...
                <tr data-doc-type-id="{{ $item->doc_type_id ?? 5 }}">
                    <td class="border px-2 py-1 text-xs @if(isset($item->disabled) && $item->disabled) line-through @endif">{!!
                        $item->name !!}</td>
                    <td class="border px-2 py-1">
                        ...
                        <a href="#" class="text-teal-600 underline ml-2 verify-link" title="Confirm Item"
                            ...
                            data-exp-dt-not-required="{{ ($empChecklist && ($empChecklist->exp_dt === null || $empChecklist->exp_dt === '')) ? 1 : 0 }}">Verify2</a>
                        @endif
                        @endif
                    </td>
