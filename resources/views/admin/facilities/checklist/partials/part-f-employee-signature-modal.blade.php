<div id="partFEmployeeSignatureModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 p-4">
    <div class="w-full max-w-2xl rounded-lg bg-white p-5 shadow-xl" role="dialog" aria-modal="true" aria-labelledby="partFEmployeeSignatureModalTitle">
        ...
        <div class="space-y-4">
            <div>
                <div class="mb-1 flex items-center justify-between gap-2">
                    ...
                    <button
                        type="button"
                        id="partFEmployeeSignatureClear"
                        class="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-800 hover:bg-slate-50"
                    >Clear</button>
                </div>
                <canvas id="partFEmployeeSignatureCanvas" width="640" height="220" class="h-[220px] w-full rounded-md border border-slate-300 bg-white touch-none"></canvas>
            ...
            <div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <label
                        for="partFEmployeeSignatureUpload"
                    ...
                    <input
                        type="file"
                        id="partFEmployeeSignatureUpload"
                        name="employee_signature_upload"
                        accept=".png,.jpg,.jpeg,.webp"
                        class="hidden"
                    >
                    <span id="partFEmployeeSignatureUploadName" class="hidden text-xs font-medium text-emerald-700"></span>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var uploadName = document.getElementById('partFEmployeeSignatureUploadName');
        ...
        var cancelBtn = document.getElementById('partFEmployeeSignatureCancel');
        var closeBtn = document.getElementById('partFEmployeeSignatureModalClose');
