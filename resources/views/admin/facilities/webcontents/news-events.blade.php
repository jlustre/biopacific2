        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">News & Events Management</h1>
                        <p class="text-gray-600">Manage news articles and events for your facilities</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-8">
            <div class="text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">News & Events Management</h3>
                <p class="text-gray-500 mb-6">Select a facility above to manage its news and events. This page will
                    allow you to:</p>
