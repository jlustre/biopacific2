    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
            ...
            <div class="text-center">
                ...
                <ul class="text-sm text-gray-600 space-y-2 max-w-md mx-auto text-left">
                    ...
                    <li class="flex items-center">
                        ...
                        <script>
                            // Attach event handlers immediately (no DOMContentLoaded wrapper)
                        ...
                        @endsection
                        d="M12 12c2.7 0 5-2.3 5-5s-2.3-5-5-5-5 2.3-5 5 2.3 5 5 5zm0 2c-3.3 0-10 1.7-10
        ...
        <div class="mb-8">
            ...
            <div class="space-y-5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    <div>
                        <label for="authorTitle" class="block text-sm font-semibold text-gray-700 mb-2">Author
                            Title</label>
                        <div class="relative">
                    ...
                    <div>
                        <label for="relationship" class="block text-sm font-semibold text-gray-700 mb-2">Relationship to
                            Facility</label>
                        <div class="relative">
        ...
        <div class="mb-8">
            ...
            <div class="space-y-5">
                <!-- Title Header -->
                <div>
                    <label for="testimonialTitleHeader" class="block text-sm font-semibold text-gray-700 mb-2">
