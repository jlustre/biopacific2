    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-8">
            <div class="text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mb-2">Careers Management</h3>
                <p class="text-gray-500 mb-6">Select a facility above to manage its career opportunities. This page will
                    allow you to:</p>
                <ul class="text-sm text-gray-600 space-y-2 max-w-md mx-auto text-left">
                    <li class="flex items-center">
                        <i class="fas fa-check text-green-500 mr-2"></i>
                        Post job openings and positions
                    </li>
                    <li class="flex items-center">
                        <i class="fas fa-check text-green-500 mr-2"></i>
                    ...
                    <li class="flex items-center">
                        <i class="fas fa-check text-green-500 mr-2"></i>
                        Set job requirements and descriptions
                    </li>
                    <li class="flex items-center">
                        <i class="fas fa-check text-green-500 mr-2"></i>
