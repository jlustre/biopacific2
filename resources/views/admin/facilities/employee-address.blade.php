...
@endphp
<div x-show="tab === 'address'" x-data="{
    showAddAddress: false,
    currentAddress: {
        address1: '', address2: '', city: '', state: '', zip: '', country: '', is_primary: '0', address_type: 'h', effdt: '', effseq: ''
    },
    latestEffdt: '{{ $latestAddrEffdt }}',
    latestEffseq: '{{ $latestAddrEffseq }}',
    setAddress(addr) {
        ...
        <div class="bg-white shadow rounded-lg p-4 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="mb-2">
                    ...
                    <select name="address_type" class="form-select w-full border border-teal-300 rounded-lg px-2 py-1"
    ...
    <div class="bg-white shadow rounded-lg p-4 mt-8">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    <td class="px-3 py-2 text-sm">{{ $addr->effdt }}</td>
                    ...
                    <td class="px-3 py-2 text-sm">{{ $addr->address1 }}</td>
                    <td class="px-3 py-2 text-sm">{{ $addr->address2 }}</td>
                    <td class="px-3 py-2 text-sm">{{ $addr->city }}</td>
