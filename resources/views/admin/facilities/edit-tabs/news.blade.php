<div id="news-content" class="tab-pane hidden">
    <div class="p-6">
        <h3 class="text-lg font-semibold text-gray-900 mb-6">News</h3>
        <div class="mb-4">
            ...
            <table class="min-w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-2 py-1">{{ $item->published_at ? $item->published_at->diffForHumans() : '-'
                            }}</td>
                        ...
                        <td class="border px-2 py-1">
                            ...
                            <button type="button" class="text-red-600 hover:underline ml-2"
                                onclick="deleteNewsItem({{ $item->id }})">Delete</button>
                        </td>
                    </tr>
                    @empty
                    <tr>
