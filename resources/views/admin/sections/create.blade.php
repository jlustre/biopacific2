...
@section('title', 'Create Layout Section')

@section('header')
<div class="flex items-center justify-between">
    <div>
        <h1 class="text-2xl font-bold text-gray-900">Create Layout Section</h1>
        <p class="text-gray-600 mt-1">Create a new reusable section for your layout templates</p>
    </div>
...
<div class="max-w-4xl mx-auto">
    <form action="{{ route('admin.sections.store') }}" method="POST" class="space-y-6" x-data="sectionForm()">
        @csrf
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div class="mt-6">
                ...
                <textarea id="description"
                          ...
                          rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                          placeholder="Describe what this section does and when to use it...">{{ old('description') }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border p-6">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    ...
                    Remember to create the corresponding Blade template files after saving
                </div>
                <div class="flex items-center gap-3">
                    <a href="{{ route('admin.sections.index') }}"
