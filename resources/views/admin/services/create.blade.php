@extends('layouts.dashboard', ['title' => 'Add Service'])

@section('header')
<div class="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
    <div>
        <h1 class="text-3xl font-bold text-gray-900">Add Service</h1>
        <p class="text-gray-600 mt-2">Create a new service for facility websites.</p>
    </div>
