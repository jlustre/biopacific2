@extends('layouts.dashboard', ['title' => 'Edit Employee File Item'])
...
<div class="mb-6">
    ...
    <h1 class="mt-2 text-2xl font-black text-slate-900">Edit employee file item</h1>
    <p class="text-sm text-slate-500">Update item details and position applicability.</p>
</div>
<div class="max-w-4xl">
