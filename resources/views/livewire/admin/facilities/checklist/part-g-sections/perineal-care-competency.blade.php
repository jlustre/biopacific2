    ...
    >
        ...
        <div>
            <table class="table w-full border border-gray-300">
                            ...
                            <div class="flex items-center justify-between gap-3">
                                <div class="flex items-center gap-2 min-w-0">
                                    ...
                                    @include('livewire.admin.facilities.checklist.part-g-sections.partials.section-title-with-status', [
                                        'title' => 'PERINEAL CARE',
                                        'sectionItems' => $perinealCareCompetencyItems,
                                    ])
                                </div>
                ...
                <tbody x-show="$store.partGAccordion && $store.partGAccordion.openSection === 'perineal-care'" x-transition>
            ...
            <div id="pcc-summary-form" tabindex="-1" class="mt-8 rounded-lg border border-gray-300 bg-slate-50 p-4 scroll-mt-4 outline-none" x-show="$store.partGAccordion && $store.partGAccordion.openSection === 'perineal-care'" x-transition>
                ...
                <div class="grid grid-cols-1 gap-4 mb-3">
                    ...
                    @include('livewire.admin.facilities.checklist.part-g-sections.partials.section-acknowledgement-host', [
                        'acknowledgementKey' => 'perineal-care',
                    ])
                </div>
            </div>
        </div>
