...
<div x-data="siteUI()" :class="{'high-contrast': highContrast, 'text-lg': largeText, 'dark': darkMode}"
  ...
  {{-- Public facility sites use partials.header only; dashboard topnav overlays block Login clicks --}}
  <div class="bg-white px-2 md:px-5 antialiased transition-colors mx-0" style="padding-top: 4rem;">
    <!-- Header -->
